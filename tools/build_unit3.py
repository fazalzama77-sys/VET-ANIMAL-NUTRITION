# tools/build_unit3.py
# Generates comprehensive, exam-oriented content for Theory Unit 3 (Applied Ruminant Nutrition-II)
# 17 topics: u3-t01 to u3-t17
...
unit3_data = {
  "u3-t01": {
    "summary": "Maintenance nutrient requirements sustain vital organ functions, basal cellular turnover, and body temperature regulation at zero body weight change, mathematically scaled to metabolic body weight (W^0.75).",
    "desc": (
      "<b>I. CONCEPT AND DEFINITION OF MAINTENANCE REQUIREMENT</b><br>"
    ...
    "keyPoints": [
      ...
      "Nutrient deficit during maintenance causes tissue catabolism, negative nitrogen balance, and weight loss."
    ],
    "clinical": (
    ...
    "tables": [
      {
        ...
        "rows": [
          ...
          ["400 kg", "89.44 kg", "8.0 – 8.5", "254 g", "3.04 kg", "11.0 Mcal"],
          ["450 kg", "97.71 kg", "9.0 – 9.5", "277 g", "3.32 kg", "12.0 Mcal"],
          ["500 kg", "105.74 kg", "10.0 – 10.5", "300 g", "3.60 kg", "13.0 Mcal"]
        ]
      },
      {
    ...
    "img": "",
    "tags": ["maintenance requirement", "basal metabolic rate", "Kleiber law", "metabolic body weight", "ICAR 2013", "EUN", "MFN"]
  },

  "u3-t02": {
    "summary": "Nutrient requirements for growth reflect changing tissue deposition: young ruminants deposit moisture and protein with high energetic efficiency, whereas maturing stock deposit dense, energy-expensive adipose tissue.",
    "desc": (
      "<b>I. COMPOSITION OF EMPTY BODY WEIGHT GAIN DURING GROWTH</b><br>"
      "Growth represents the progressive increase in structural mass, skeletal bone, and muscular organs until mature body dimensions are attained. The nutritional cost of body gain changes dramatically as the animal matures:<br>"
      "<ul>"
      "<li><b>Early Growth (Young Calves & Weaners):</b> Body gain consists predominantly of water (70–75%) and protein (18–20%), with minimal fat (4–8%) and minerals (3–4%). Because lean muscle tissue is approximately 75% water, the gross energy value of early lean gain is low: only <b>1.2 to 1.5 kcal/g fresh gain</b>.</li>"
      "<li><b>Intermediate Growth (Heifers & Stockers):</b> Protein deposition plateaus while adipose tissue hypertrophy accelerates. Gain consists of 50–55% water, 15–16% protein, and 25–30% fat.</li>"
      "<li><b>Finishing / Late Growth (Fattening Bullocks & Buffaloes):</b> Gain consists predominantly of adipose tissue (50–65% fat), with declining water (30–35%) and minimal protein (8–10%). Because anhydrous fat contains 9.4 kcal/g, the energy cost of late finishing gain escalates to <b>6.0 to 7.5 kcal/g fresh gain</b>.</li>"
      "</ul>"
      ...
      "<li><b>Energy for Gain:</b> Approximately 1.2 to 1.5 kg of TDN (or 4.5 to 5.5 Mcal ME) per kg of live weight gain in young stock, rising to 2.5–3.0 kg TDN/kg gain in finishing cattle depositing fat.</li>"
      "</ul>"
      "<b>III. THE PHENOMENON OF COMPENSATORY (CATCH-UP) GROWTH</b><br>"
      "Compensatory growth is the rapid, accelerated growth rate exhibited by animals following a period of nutritional deprivation, once ad libitum balanced feeding is restored.<br><br>"
      "<b>Physiological Mechanisms:</b><br>"
      "1. <i>Reduced Maintenance Basal Heat:</i> During starvation, visceral organ mass (liver, gut mucosa) shrinks, dropping maintenance energy expenditure by 15–25%. This depressed maintenance cost persists into early realimentation.<br>"
      "2. <i>Surge in Voluntary Dry Matter Intake:</i> Animals consume 20–30% more feed per unit body weight.<br>"
      "3. <i>High Efficiency of Lean Accretion:</i> Early realimentation tissue gain consists almost entirely of protein and associated hydration water, requiring far less energy per kg gain than fat deposition."
    ),
    "eliteDesc": (
      "<b>Endocrine Dynamics of Growth and Nutrient Partitioning:</b><br>"
      "Skeletal muscle accretion is governed by the <b>Somatotropic Axis</b> (Growth Hormone - GH / Somatotropin, and Insulin-like Growth Factor 1 - IGF-1). In adequately fed heifers, pituitary GH binds hepatic GHR receptors to stimulate circulating IGF-1, driving amino acid uptake and protein synthesis in skeletal muscle satellite cells. Under-nutrition uncouples this axis (high circulating GH but low IGF-1 due to hepatic receptor downregulation). Excess energy feeding in prepubertal heifers (ADG >750 g/day) drives elevated estrogen and prolactin surges, triggering premature adipocyte infiltration into the mammary fat pad, destroying developing secretory ductal parenchyma and permanently lowering future lactation potential by 20–30%."
    ),
    "keyPoints": [
      ...
      "Overfeeding energy to prepubertal heifers (ADG >750 g/day) causes 'fat heifer syndrome' and reduces milk yield.",
      "Calcium and Phosphorus in 1.5:1 to 2:1 ratio are vital for skeletal ossification during rapid frame growth.",
      "Buffalo meat (carabeef) animals exhibit superior efficiency on high-roughage diets due to slower maturity."
    ],
    "clinical": (
      "<b>Targeting Age at First Calving (AFC) in Indian Dairying:</b><br>"
      "A disastrous economic drain in Indian dairy farming is delayed Age at First Calving (AFC), often exceeding 36 to 48 months in Murrah buffaloes and indigenous cattle due to calf starvation. Calves fed straw with negligible concentrate gain <200 g/day. Scientifically managing growth with 1.5-2.0 kg balanced calf grower concentrate + cultivated greens achieves an ADG of 500-550 g/day, allowing crossbred heifers to reach the critical breeding threshold weight of <b>275-300 kg (65% of mature weight) by 15-18 months of age</b>, achieving calving at 24-27 months."
    ),
    "tables": [
      {
        "title": "Dynamic Shifts in Body Composition of Growing Ruminants",
        "headers": ["Stage of Growth", "Live Weight Range", "Water Content (%)", "Protein Content (%)", "Fat Content (%)", "Energy Cost per kg Gain"],
        "rows": [
          ["Young Pre-Ruminant Calf", "30 – 70 kg", "72 – 76 %", "19 – 21 %", "3 – 5 %", "1.2 – 1.6 Mcal / kg"],
          ["Weaned Growing Heifer", "100 – 200 kg", "64 – 68 %", "17 – 19 %", "10 – 14 %", "2.2 – 2.8 Mcal / kg"],
          ["Breeding Age Heifer", "250 – 350 kg", "55 – 60 %", "15 – 17 %", "20 – 25 %", "3.8 – 4.5 Mcal / kg"],
          ["Finishing Fattening Steer", "400 – 500 kg", "40 – 48 %", "11 – 13 %", "38 – 48 %", "6.0 – 7.2 Mcal / kg"]
        ]
      },
      {
        "title": "ICAR (2013) Daily Nutrient Guidelines for Growing Crossbred Heifers (500 g ADG Target)",
        "headers": ["Body Weight (kg)", "Dry Matter Intake (kg)", "DCP Allowance (g)", "TDN Allowance (kg)", "Calcium (g)", "Phosphorus (g)"],
        "rows": [
          ["100 kg", "2.6 – 2.8 kg", "240 g", "1.60 kg", "16 g", "11 g"],
          ["150 kg", "3.6 – 3.9 kg", "285 g", "2.20 kg", "19 g", "13 g"],
          ["200 kg", "4.6 – 5.0 kg", "325 g", "2.75 kg", "22 g", "15 g"],
          ["250 kg", "5.5 – 6.0 kg", "360 g", "3.25 kg", "24 g", "16 g"],
          ["300 kg", "6.4 – 7.0 kg", "390 g", "3.75 kg", "26 g", "17 g"]
        ]
      }
    ],
    "img": "",
    "tags": ["growth nutrition", "ADG", "body composition", "compensatory growth", "fat heifer syndrome", "heifer rearing", "ICAR 2013"]
  },

  "u3-t03": {
    "summary": "Gestation demands little extra nutrition in early pregnancy, but escalates exponentially in the final trimester as 75-80% of fetal growth, mammary mammogenesis, and colostrum synthesis occur simultaneously.",
    "desc": (
      "<b>I. BIPHASIC NATURE OF GESTATIONAL NUTRIENT DEMAND</b><br>"
      "The nutrient demands of gestation follow an asymmetric, exponential curve:<br>"
      "<ul>"
      "<li><b>First and Second Trimester (Day 0 to Month 6 in Cattle):</b> Fetal mass accretion is biologically minimal. At 5 months gestation, a bovine fetus weighs barely 2.0 to 2.5 kg. Maintenance rations (plus normal lactation allowances if the cow is being milked) are entirely sufficient. Excess feeding during this stage causes maternal obesity without benefiting the fetus.</li>"
      "<li><b>Third Trimester (Final 60 to 75 Days):</b> Over <b>75% to 80% of total fetal weight</b> is deposited during the last two months of gestation (fetal weight jumps from ~5 kg to 25–40 kg at term). Concurrently, rapid placental growth, amniotic/allantoic fluid accumulation, uterine hypertrophy, and extensive mammary gland ductal-alveolar development (mammogenesis) take place.</li>"
      "</ul>"
      "<b>II. QUANTITATIVE NUTRIENT ALLOWANCES IN LATE PREGNANCY</b><br>"
      "During the final 2 months of pregnancy, the pregnant cow or buffalo must receive a dedicated <b>Pregnancy Allowance</b> supplied strictly over and above her maintenance requirement:<br>"
      "<ul>"
      "<li><b>Dry Matter Intake Challenge:</b> As the gravid uterus expands to 50–70 kg (fetus + fluids + placenta), it physically compresses the adjacent reticulo-rumen, reducing voluntary rumen capacity and DMI by 15% to 25% just when nutrient demand peaks.</li>"
      "<li><b>Energy Requirement:</b> Add 1.0 to 1.5 kg TDN (or 4.0 to 5.5 Mcal ME) daily above maintenance.</li>"
      "<li><b>Protein Requirement:</b> Add 150 to 200 g DCP daily above maintenance to support fetal muscular protein synthesis and maternal colostrogenesis.</li>"
      "<li><b>Mineral & Vitamin Demands:</b> Daily fetal skeletal mineralization requires an extra 15–20 g Calcium and 10–12 g Phosphorus. Vitamin A (carotene) supplementation (minimum 40,000–50,000 IU/day) is critical; calves are born with zero hepatic Vitamin A reserves and depend entirely on maternal placental transfer and colostrum.</li>"
      "</ul>"
    ...
    "eliteDesc": (
      "<b>Uteroplacental Energetics and Substrate Utilization:</b><br>"
      "The bovine gravid uterus consumes approximately 25% of total whole-body maternal glucose turnover in late gestation. Crucially, the placenta and fetus rely exclusively on <b>glucose and amino acids</b> for oxidative metabolism and tissue synthesis; long-chain fatty acids (NEFA) cross the syndesmochorial placenta in negligible amounts. The fetus oxidizes glucose into lactate, with the placenta consuming up to 60–70% of the glucose extracted from uterine arterial blood. If maternal propionate supply (from ruminal starch) is inadequate, the dam must upregulate hepatic gluconeogenesis from amino acids and glycerol, inducing maternal muscle wasting and predisposing to prepartum ketosis."
    ),
    "keyPoints": [
      "Fetal growth is exponential: 75-80% of fetal mass is accreted during the final 60-75 days of gestation.",
      "Nutrient requirements during the first 6 months of gestation are negligible above maintenance.",
      "The expanding gravid uterus physically compresses the rumen, reducing DMI by 15-25% near term.",
      "Pregnancy allowance for dairy cows: 150-200 g DCP and 1.0-1.5 kg TDN daily above maintenance.",
      "Feed density must be increased during the dry transition period to compensate for reduced voluntary intake.",
      "Fetal skeletal ossification extracts 15-20 g Calcium and 10-12 g Phosphorus daily in late pregnancy.",
      "Calves are born with zero vitamin A reserves; maternal carotene supplementation is mandatory.",
      "The gravid uterus consumes 25% of maternal glucose; fatty acids do not effectively cross the placenta.",
      "Maternal starvation causes weak calf syndrome, retained placenta, and post-partum anestrus.",
      "In sheep and goats, late pregnancy energy deficit triggers acute pregnancy toxemia (twin lamb disease)."
    ],
    "clinical": (
      "<b>Pregnancy Toxaemia (Twin Lamb Disease) in Ewes & Does:</b><br>"
      "In prolific indigenous sheep (e.g. Garole, Malpura) and goats (Black Bengal, Barbari) carrying twins or triplets, the energy demand in the final 4 weeks of gestation doubles while multiple fetuses drastically compress the rumen. If ewes are fed poor-quality dry roughage without grain concentrate, acute hypoglycemia develops (blood glucose <25 mg/dL). Massive mobilization of maternal body fat overwhelms hepatic oxidation, flooding maternal blood with ketone bodies (BHBA >3.0 mmol/L). Affected ewes develop <b>Pregnancy Toxaemia</b>: neurological blindness, tremors, teeth grinding, recumbency, coma, and death. Oral drenching with 100 mL propylene glycol or glycerol twice daily + IV glucose saves the animals if administered early."
    ),
    "tables": [
      {
        "title": "Fetal Mass and Gestational Nutrient Acceleration in Dairy Cattle",
        "headers": ["Gestation Stage", "Bovine Fetal Weight", "Uteroplacental Tissue Weight", "% of Total Fetal Gain", "Nutritional Allocation Strategy"],
        "rows": [
          ["1st Trimester (0 – 3 Months)", "< 0.5 kg", "< 0.8 kg", "< 2 %", "Base maintenance + lactation ration; no extra pregnancy feed"],
          ["2nd Trimester (4 – 6 Months)", "1.0 – 3.5 kg", "2.0 – 4.0 kg", "~ 8 %", "Standard maintenance ration; avoid maternal fattening"],
          ["Month 7 (Start of Dry Period)", "6.0 – 9.0 kg", "6.0 – 8.0 kg", "~ 15 %", "Initiate dry cow transition ration; add 1.0 kg concentrate"],
          ["Month 8 (Late Gestation)", "12.0 – 18.0 kg", "10.0 – 12.0 kg", "~ 25 %", "Add 1.5 kg concentrate; ensure mineral-vitamin fortification"],
          ["Month 9 (Final Month / Term)", "25.0 – 40.0 kg", "15.0 – 20.0 kg", "~ 50 %", "Steaming up / lead feeding; high nutrient density to counter drop in DMI"]
        ]
      },
      {
        "title": "ICAR (2013) Recommended Allowances for Gestating Cattle and Buffaloes (Last 2 Months)",
        "headers": ["Nutrient Parameter", "Base Maintenance (400 kg)", "Pregnancy Allowance", "Total Daily Gestation Allowance"],
        "rows": [
          ["Dry Matter Intake (DMI)", "8.0 – 8.5 kg", "Rumen capacity drops ~15%", "7.5 – 8.0 kg (Requires higher nutrient density)"],
          ["Digestible Crude Protein (DCP)", "254 g", "+ 180 – 200 g", "434 – 454 g / day"],
          ["Total Digestible Nutrients (TDN)", "3.04 kg", "+ 1.20 – 1.40 kg", "4.24 – 4.44 kg / day"],
          ["Metabolizable Energy (ME)", "11.0 Mcal", "+ 4.5 – 5.0 Mcal", "15.5 – 16.0 Mcal / day"],
          ["Calcium (Ca)", "18 g", "+ 16 g", "34 g / day"],
          ["Phosphorus (P)", "12 g", "+ 11 g", "23 g / day"]
        ]
      }
    ],
    "img": "",
    "tags": ["gestation nutrition", "pregnancy allowance", "fetal growth curve", "transition period", "pregnancy toxaemia", "colostrogenesis", "ICAR 2013"]
  },

  "u3-t04": {
    "summary": "Milk production requirements demand high concentrations of energy, glucose precursors, and amino acids proportional to yield and fat percentage, with buffalo milk requiring 30% higher energy per liter than cow milk.",
    "desc": (
      "<b>I. METABOLIC DEMANDS OF LACTATION</b><br>"
      "Lactation represents the most physiologically demanding phase in the life of a female mammal. A high-yielding dairy cow or buffalo secretes more dry matter, energy, protein, and minerals in her milk in 60 days than was contained in her entire body at calving.<br><br>"
      "<b>Comparative Milk Composition: Cow vs. Buffalo:</b><br>"
      "<ul>"
      "<li><b>Crossbred Cow Milk (3.5–4.0% Fat):</b> Contains ~12.5% total solids: 3.5–4.0% fat, 3.2% protein (casein), 4.8% lactose, and 0.7% minerals (1.2 g Ca, 0.9 g P per liter).</li>"
      "<li><b>Murrah Buffalo Milk (7.0–8.0% Fat):</b> Contains ~17.5% total solids: 7.0–8.0% fat, 4.0% protein, 5.2% lactose, and 0.8% minerals (1.8 g Ca, 1.3 g P per liter). Because fat contains 9.4 kcal/g compared to 4.1 kcal/g for lactose and protein, buffalo milk has vastly higher gross energy content (~1050 kcal/kg vs. ~700 kcal/kg in cow milk).</li>"
      "</ul>"
      ...
      "<ul>"
      "<li><b>For Crossbred Cow Milk (4.0% Fat):</b> Add <b>0.30 kg TDN</b> and <b>45 g DCP</b> per kg of milk.</li>"
      "<li><b>For Indigenous Zebu Cow Milk (4.5% Fat):</b> Add <b>0.32 kg TDN</b> and <b>48 g DCP</b> per kg of milk.</li>"
      "<li><b>For Murrah Buffalo Milk (7.0% Fat):</b> Add <b>0.37 kg TDN</b> and <b>65 g DCP</b> per kg of milk.</li>"
      "<li><b>Minerals per kg Milk:</b> Add 2.8 to 3.0 g Calcium and 2.0 to 2.2 g Phosphorus for cow milk; add 3.8 to 4.2 g Calcium and 2.8 to 3.0 g Phosphorus for buffalo milk.</li>"
      "</ul>"
      "<b>IV. THE EARLY LACTATION NEGATIVE ENERGY BALANCE (NEB)</b><br>"
      "In early lactation (Weeks 1 to 8 postpartum), milk production surges rapidly to peak yield at 4–6 weeks, whereas voluntary feed intake does not peak until 8–10 weeks postpartum. High yielders inevitably enter <b>Negative Energy Balance (NEB)</b>, mobilizing up to 0.5–1.0 kg of adipose tissue daily (losing 0.5–1.0 unit of Body Condition Score, BCS). Rations must be formulated with maximum permissible nutrient density (50:50 R:C ratio, bypass fat) to minimize NEB depth."
    ),
    "eliteDesc": (
    ...
    "keyPoints": [
      ...
      "Lactose is synthesized from blood glucose, derived almost entirely from ruminal propionate gluconeogenesis.",
      "Milk fat is 50% synthesized de novo from ruminal acetate/BHBA and 50% from circulating long-chain fatty acids.",
      "Each liter of cow milk secretes 1.2 g Calcium and 0.9 g Phosphorus; buffalo milk secretes 1.8 g Ca and 1.3 g P.",
      "Thumb rule: feed 1 kg concentrate for every 2.5 kg cow milk, or 1 kg concentrate for every 2.0 kg buffalo milk."
    ],
    "clinical": (
    ...
    "tables": [
      {
        "title": "Comprehensive Nutritional Comparison: Cow Milk vs Water Buffalo Milk",
        "headers": ["Compositional Parameter", "Crossbred Cow Milk (3.5–4.0% Fat)", "Murrah Buffalo Milk (7.0–8.0% Fat)", "Physiological / Nutritional Impact"],
        "rows": [
          ["Total Solids (%)", "12.2 – 12.8 %", "17.0 – 18.5 %", "Buffalo milk yields 40% more paneer, ghee, and khoa per liter"],
          ["Milk Fat (%)", "3.5 – 4.0 %", "7.0 – 8.2 %", "Demands massive acetate and BHBA precursor supply from rumen"],
          ["Milk Protein (Casein, %)", "3.1 – 3.3 %", "3.8 – 4.2 %", "Higher bypass protein and amino acid demand in buffalo rations"],
          ["Lactose Content (%)", "4.6 – 4.8 %", "5.0 – 5.4 %", "Demands higher hepatic propionate-glucose flux in buffaloes"],
          ["Gross Energy per Liter", "~680 – 720 kcal", "~1020 – 1100 kcal", "Buffalo milk requires 30% higher dietary energy per liter"],
          ["Calcium Secreted per Liter", "1.2 g / L", "1.8 g / L", "Buffaloes have higher dietary calcium demand to prevent hypocalcemia"]
        ]
      },
      {
        "title": "ICAR (2013) Production Nutrients Required per kg Milk across Fat Levels",
        "headers": ["Milk Fat Percentage", "DCP Required per kg Milk", "TDN Required per kg Milk", "ME Required per kg Milk", "Equivalent Concentrates"],
        "rows": [
          ["3.0 % Fat (Holstein Friesian)", "42 g DCP", "0.26 kg TDN", "0.95 Mcal ME", "0.35 kg balanced mix"],
          ["3.5 % Fat (Crossbred Cow)", "45 g DCP", "0.28 kg TDN", "1.02 Mcal ME", "0.38 kg balanced mix"],
          ["4.0 % Fat (Jersey / Crossbred)", "48 g DCP", "0.31 kg TDN", "1.12 Mcal ME", "0.40 kg (1 kg per 2.5 L)"],
          ["5.0 % Fat (Indigenous Zebu)", "53 g DCP", "0.35 kg TDN", "1.27 Mcal ME", "0.45 kg balanced mix"],
          ["6.0 % Fat (Buffalo / High Zebu)", "58 g DCP", "0.38 kg TDN", "1.38 Mcal ME", "0.48 kg balanced mix"],
          ["7.0 % Fat (Murrah Buffalo)", "65 g DCP", "0.42 kg TDN", "1.52 Mcal ME", "0.50 kg (1 kg per 2.0 L)"],
          ["8.0 % Fat (High Fat Buffalo)", "72 g DCP", "0.46 kg TDN", "1.67 Mcal ME", "0.55 kg balanced mix"]
        ]
      }
    ],
    "img": "",
    "tags": ["milk production", "4% FCM", "Gaines formula", "cow vs buffalo milk", "negative energy balance", "ketosis", "ICAR 2013"]
  },

  "u3-t05": {
    "summary": "Wool growth demands high dietary sulfur and sulfur-containing amino acids (methionine, cystine) for keratin synthesis, showing priority over body tissue gain during moderate nutritional restriction.",
    "desc": (
    ...
    "keyPoints": [
      ...
      "Copper is an essential cofactor for thiol oxidase; deficiency causes 'steely' or 'stringy' uncrimped wool.",
      "Zinc deficiency causes parakeratosis of wool follicles, wool shedding, and brittle fleeces.",
      "Sudden nutritional starvation produces a 'hunger trace' or 'wool break', weakening fleece tensile strength.",
      "Fine-wool Indian breeds: Chokla, Nali, Bharat Merino; coarse carpet wool breeds: Marwari, Malpura.",
      "Rumen-protected methionine (RPM) escapes ruminal degradation, boosting wool yield by 30-50%."
    ],
    "clinical": (
    ...
    "tables": [
      ...
      {
        "title": "Daily Nutrient Recommendations for Wool-Producing Sheep (50 kg Adult, ICAR Standards)",
        "headers": ["Production Status", "DMI (kg/day)", "DCP (g/day)", "TDN (kg/day)", "Sulfur (g/day)", "Copper (mg/day)"],
        "rows": [
          ["Adult Maintenance (Carpet Wool)", "1.2 – 1.4 kg", "55 g", "0.65 kg", "1.8 g", "8.0 mg"],
          ["Fine Wool Production (Chokla/Merino)", "1.4 – 1.6 kg", "80 g", "0.80 kg", "2.6 g", "10.0 mg"],
          ["Flushing (Pre-Breeding)", "1.6 – 1.8 kg", "95 g", "0.95 kg", "2.8 g", "10.0 mg"],
          ["Late Pregnancy (Last 4 Weeks)", "1.5 – 1.7 kg", "110 g", "1.05 kg", "3.0 g", "12.0 mg"]
        ]
      }
    ],
    "img": "",
    "tags": ["wool nutrition", "keratin", "cystine", "sulfur amino acids", "steely wool", "N:S ratio", "copper deficiency", "Chokla sheep"]
  },

  "u3-t06": {
    "summary": "Working and draft bullocks demand substantial energy derived from carbohydrate and volatile fatty acid oxidation to generate mechanical power, without significant increases in protein requirements.",
    "desc": (
      "<b>I. PHYSIOLOGY OF MECHANICAL WORK IN DRAFT ANIMALS</b><br>"
      "Working bullocks, camels, and draft equines convert dietary chemical energy into mechanical tractive work for agricultural plowing, threshing, water lifting, and cart haulage.<br><br>"
      "<b>Draft Power and Tractive Effort:</b><br>"
      ...
      "</ul>"
      "<b>III. CLASSIFICATION OF WORK AND PRACTICAL CONCENTRATE ALLOWANCES</b><br>"
      "Under <b>ICAR (2013) standards</b>, work intensity in bullocks is categorized into three tiers:<br>"
      "<ul>"
      "<li><b>1. Light Work (2 to 4 hours/day):</b> Light carting or shallow inter-culture cultivation. Add <b>0.5 to 0.7 kg TDN</b> (approx. 1.0 kg balanced concentrate mixture) over base maintenance.</li>"
      "<li><b>2. Medium Work (4 to 6 hours/day):</b> Normal field plowing in light to medium soils. Add <b>1.0 to 1.3 kg TDN</b> (approx. 1.5 to 2.0 kg balanced concentrate mixture) over base maintenance.</li>"
      "<li><b>3. Heavy Work (6 to 8 hours/day):</b> Deep plowing in heavy black cotton soils, water lifting, or heavy road haulage. Add <b>1.6 to 2.0 kg TDN</b> (approx. 2.5 to 3.0 kg balanced concentrate mixture) over base maintenance.</li>"
      "</ul>"
      "<b>IV. WATER AND ELECTROLYTE METABOLISM DURING WORK</b><br>"
      "Working bullocks dissipate the massive heat of muscular contraction primarily through <b>sweating and polypnea (panting)</b>. In hot Indian summer months, working bullocks lose 20 to 40 liters of water and substantial sodium and chloride daily. Water must be offered ad libitum thrice daily, and the salt allowance must be increased to <b>50 to 80 g common salt daily</b>."
    ),
    "eliteDesc": (
    ...
    "keyPoints": [
      ...
      "Renowned Indian draft breeds: Nagori, Hariana, Hallikar, Amritmahal, Khillari.",
      "Muscular work demands energy (ATP), NOT structural protein; protein requirements rise minimally.",
      "Circulating ruminal acetate and fatty acids fuel aerobic work; glycogen fuels heavy peak draft.",
      "Net mechanical efficiency of draft work is 25-30%; the remaining 70-75% is dissipated as heat.",
      "ICAR work classification: Light (2-4 hrs), Medium (4-6 hrs), Heavy (6-8 hrs).",
      "Concentrate supplementation above maintenance: 1 kg (Light), 2 kg (Medium), 3 kg (Heavy work).",
      "Feeding excess protein concentrate to working bullocks increases metabolic heat stress.",
      "Working bullocks in tropical summer lose 20-40 L of water via sweating, demanding 50-80 g salt daily.",
      "Feeding 1-2 kg molasses provides rapid sucrose/fructose energy for hepatic glycogen replenishment."
    ],
    "clinical": (
    ...
    "tables": [
      {
        "title": "Classification of Work Intensity and Daily Nutrient Additions for Bullocks (ICAR 2013)",
        "headers": ["Work Category", "Daily Working Duration", "Field Operations Included", "Extra TDN Above Maintenance", "Extra DCP Above Maintenance", "Extra Balanced Concentrate"],
        "rows": [
          ["Light Work", "2 – 4 Hours / day", "Light carting on paved road; inter-row weeding", "+ 0.60 kg TDN", "+ 40 g DCP", "+ 1.0 kg concentrate"],
          ["Medium Work", "4 – 6 Hours / day", "Normal plowing in sandy-loam soils; harrowing", "+ 1.15 kg TDN", "+ 75 g DCP", "+ 1.8 – 2.0 kg concentrate"],
          ["Heavy Work", "6 – 8 Hours / day", "Deep subsoil plowing; wet paddy puddling; heavy load carting", "+ 1.80 kg TDN", "+ 120 g DCP", "+ 2.8 – 3.0 kg concentrate"]
        ]
      },
      {
        "title": "Draft Performance and Working Capacity of Premier Indian Cattle Breeds",
        "headers": ["Breed Name", "Home Tract / State", "Average Adult Weight", "Normal Draft Force", "Prominent Draft Characteristic"],
        "rows": [
          ["Nagori", "Nagaur (Rajasthan)", "400 – 450 kg", "50 – 55 kg", "Fast trotting, long-legged; premier cart and road draft breed"],
          ["Hariana", "Rohtak / Haryana", "420 – 480 kg", "52 – 58 kg", "Powerful dual-purpose; exceptional endurance for heavy plowing"],
          ["Hallikar", "Karnataka", "380 – 420 kg", "48 – 52 kg", "Compact, energetic, high tractive force; famous Mysore draft breed"],
          ["Amritmahal", "Karnataka", "400 – 440 kg", "50 – 54 kg", "Historic military draft breed; fiery temperament and great speed"],
          ["Khillari", "Maharashtra", "400 – 460 kg", "50 – 56 kg", "Hardy, adapted to drought and stony Deccan plateau soils"]
        ]
      }
    ],
    "img": "",
    "tags": ["working animals", "draft bullocks", "tractive force", "energy for work", "heat exhaustion", "draft breeds", "ICAR 2013"]
  },

  "u3-t07": {
    "summary": "Ration balancing combines available roughages and concentrates using algebraic, Pearson's square, or computer linear programming techniques to satisfy dry matter, protein, and energy standards at least cost.",
    "desc": (
      "<b>I. OBJECTIVE OF RATION BALANCING</b><br>"
      "Ration computation is the practical mathematical translation of feeding standards into daily feed allowances. The goal is to formulate a ration from locally available, economical feeds that supplies exact requirements of Dry Matter (DM), Digestible Crude Protein (DCP), and Total Digestible Nutrients (TDN) or Metabolizable Energy (ME) without nutritional deficiencies or wasteful excesses.<br><br>"
      "<b>II. THE FOUR CLASSICAL COMPUTATION METHODS</b><br>"
      "<ul>"
      ...
      "To formulate a 20% Crude Protein (CP) concentrate mixture using Maize grain (9% CP) and Mustard Oilcake (35% CP):<br>"
      ...
      "3. <i>Step 3:</i> Allocate total DMI into Roughage DM (60–70%) and Concentrate DM (30–40%).<br>"
      "4. <i>Step 4:</i> Fulfill carotene/vitamin A needs by allocating available fresh green fodder (minimum 10–15 kg fresh weight).<br>"
      "5. <i>Step 5:</i> Fulfill the remaining roughage DM quota with chaffed dry crop residue (wheat straw, paddy straw).<br>"
      "6. <i>Step 6:</i> Calculate nutrients supplied by roughages; calculate remaining deficit in DCP and TDN; formulate the concentrate mixture to bridge this exact deficit."
    ),
    "eliteDesc": (
    ...
    "keyPoints": [
      ...
      "The four methods: Trial-and-error, Pearson's square, Algebraic equations, and Linear programming.",
      "Pearson's Square balances one nutrient (e.g. CP) using two feeds or two mixtures.",
      "Pearson's Square requires the target value to lie strictly between the values of the two ingredients.",
      "Algebraic equations solve for two nutrients (DCP and TDN) simultaneously using two unknowns.",
      "Linear programming uses the Simplex algorithm to minimize cost while satisfying all nutrient bounds.",
      "Dry Matter Intake (DMI) is the primary constraint within which all nutrients must be packed.",
      "Green fodder (10-15 kg) is allocated first to ensure natural carotene and succulent fiber.",
      "Roughage dry matter should represent at least 60-70% of total diet DM in normal production.",
      "Concentrate mixture bridges the final deficit in DCP and TDN left by roughages."
    ],
    "clinical": (
    ...
    "tables": [
      {
        "title": "Worked Example: Pearson's Square Formulation for a 20% CP Dairy Concentrate",
        "headers": ["Square Position", "Ingredient Name", "Ingredient CP (%)", "Diagonally Subtracted Parts", "Proportion in 100 kg Mix"],
        "rows": [
          ["Upper Left Corner", "Maize Grain", "9.0 % CP", "| 35 – 20 | = 15 parts Maize", "(15 / 26) × 100 = 57.69 % Maize"],
          ["Lower Left Corner", "Mustard Oilcake", "35.0 % CP", "| 9 – 20 | = 11 parts Mustard Cake", "(11 / 26) × 100 = 42.31 % Mustard Cake"],
          ["Center of Square", "Target Concentrate", "20.0 % CP", "Total Parts = 15 + 11 = 26 parts", "Total Mix = 100.00 % (20% CP)"]
        ]
      },
      {
        "title": "Comparison of Ration Balancing Methodologies",
        "headers": ["Methodology", "Mathematical Basis", "Number of Feeds Handled", "Accuracy & Speed", "Best Application"],
        "rows": [
    ...
    "img": "",
    "tags": ["ration computation", "ration balancing", "Pearson square", "least-cost ration", "ICAR 2013", "concentrate formulation", "algebraic method"]
  },

  "u3-t08": {
    "summary": "Neonate calves are non-ruminants dependent on early colostrum feeding for systemic passive immunity, transitioning via calf starter and good hay to stimulate ruminal papillae development and early weaning.",
    "desc": (
      "<b>I. THE NEONATAL GASTROINTESTINAL ANATOMY</b><br>"
      "At birth, the calf is functionally a <b>monogastric (non-ruminant)</b>. The reticulo-rumen is undeveloped, flaccid, and non-functional, accounting for barely 30% of total stomach capacity, while the <b>abomasum (true stomach)</b> represents over 60%.<br><br>"
    ...
    "keyPoints": [
      ...
      "The reticular groove reflex shunts suckled milk directly past the rumen into the abomasum.",
      "Gulp-feeding milk from open buckets causes 'ruminal drinking' and putrid bacterial scours.",
      "Calves are born agammaglobulinemic due to the impermeable synepitheliochorial placenta.",
      "Colostrum must be fed at 10% of body weight within the first 1-2 hours of life.",
      "Intestinal pinocytosis of immunoglobulins ceases irreversibly at 24 hours ('gut closure').",
      "Failure of Passive Transfer (FPT = serum IgG <10 mg/mL) multiplies calf mortality risk.",
      "Volatile Fatty Acids (especially Butyrate) from calf starter stimulate ruminal papillae development.",
      "Forage hay supplies the physical 'scratch factor' that stimulates ruminal muscular wall expansion.",
      "Calves can be successfully weaned once they consume 750-1000 g of calf starter daily (8-12 weeks)."
    ],
    "clinical": (
    ...
    "tables": [
      {
        "title": "Compositional Comparison: Bovine Colostrum (First Milking) vs Mature Whole Milk",
        ...
        "rows": [
          ...
          ["Fat (%)", "6.0 – 8.0 %", "3.5 – 4.0 %", "High energy density; stimulates brown adipose tissue thermogenesis"],
          ["Vitamin A / Carotene", "10 – 15 times higher", "Baseline reference", "Builds neonatal hepatic stores; seals gut mucosal barrier"],
          ["Trypsin Inhibitors", "High concentration", "Negligible", "Protects ingested immunoglobulins from enzymatic degradation"]
        ]
      },
      {
        "title": "Standard Feeding Schedule for Dairy Calves from Birth to Weaning (12 Weeks)",
        "headers": ["Age Period", "Whole Milk / Milk Replacer", "Calf Starter (22% CP, 75% TDN)", "Good Legume Hay", "Clean Drinking Water"],
        "rows": [
          ["Day 1 (0 to 24 Hours)", "Colostrum (10% BW; 3–4 L in split doses)", "None", "None", "Offered warm after colostrum"],
          ["Day 2 to Day 7", "Colostrum / Whole milk (1/10th BW)", "Introduce small handful daily", "None", "Fresh, clean ad libitum"],
          ["Week 2 to Week 3", "Whole milk (1/10th BW, ~3.5 L/day)", "Free access (keep fresh daily)", "Introduce fine chaffed hay", "Fresh, clean ad libitum"],
          ["Week 4 to Week 6", "Whole milk (1/10th BW, max 4 L/day)", "Intake increases to 300–500 g/day", "Free choice in hay rack", "Fresh, clean ad libitum"],
          ["Week 7 to Week 8", "Reduce milk gradually (2.0 L/day)", "Intake reaches 600–800 g/day", "Free choice in hay rack", "Fresh, clean ad libitum"],
          ["Week 9 to Week 12", "Taper to 1 L, then wean at W12", "Intake reaches 1.0 – 1.2 kg/day", "Ad libitum greens + hay", "Fresh, clean ad libitum"]
        ]
      }
    ],
    "img": "",
    "tags": ["calf nutrition", "colostrum", "reticular groove", "passive immunity", "gut closure", "calf starter", "rumen development", "weaning"]
  },

  "u3-t09": {
    "summary": "Growing heifers require balanced nutrient density to achieve 500-600 g daily gain and reach puberty by 15-18 months, while avoiding excessive energy that induces irreversible mammary fat deposition.",
    "desc": (
      "<b>I. STRATEGIC OBJECTIVES OF HEIFER REARING</b><br>"
      "Heifers represent the genetic future and capital investment of a dairy enterprise. Rearing management must aim to achieve sexual maturity, successful conception, and healthy skeletal development at minimum cost and without reproductive delays.<br><br>"
      "<b>Key Performance Benchmarks:</b><br>"
      "<ul>"
      "<li><b>Target Average Daily Gain (ADG):</b> 500 to 600 g/day in crossbred heifers; 450 to 500 g/day in Murrah buffalo heifers.</li>"
      "<li><b>Breeding Benchmark:</b> Achieve <b>60% to 65% of mature adult body weight</b> (275–300 kg in crossbreds; 300–325 kg in Murrah buffaloes) by <b>15 to 18 months of age</b>.</li>"
      "<li><b>Age at First Calving (AFC):</b> Target 24 to 28 months in crossbred cattle, and 30 to 36 months in buffaloes.</li>"
      "</ul>"
      ...
      "Adult non-producing cattle and buffaloes (dry cows, resting draft bullocks) require stable maintenance nutrition. Diets based on cereal crop residues (wheat or paddy straw) must be fortified with: (a) 10–15 kg seasonal green fodder to supply carotene; (b) 1.0–1.5 kg maintenance concentrate; and (c) 1% mineral mixture and salt to maintain bodily homeostasis and prevent reproductive quiescence."
    ),
    "eliteDesc": (
    ...
    "keyPoints": [
      ...
      "Target Age at First Calving (AFC): 24-28 months in crossbreds; 30-36 months in buffaloes.",
      "Heifers must be bred at 60-65% of mature adult weight (275-300 kg), not based on age alone.",
      "Post-weaning heifers (3-6 months) have limited rumen volume and require nutrient-dense concentrates.",
      "Overfeeding energy before puberty (ADG >700 g/day) causes 'fat heifer syndrome' and reduces milk yield.",
      "Allometric mammary growth (3-10 months) requires high protein and moderate energy to protect the duct network.",
      "Skeletal frame expansion requires optimal Calcium:Phosphorus ratio (1.5:1 to 2:1) and trace minerals.",
      "Breeding heifers (12-18 months) can be maintained on good cultivated green forages with minimal grain.",
      "Adult dry stock require maintenance rations preventing both emaciation (BCS <2.5) and obesity (BCS >3.75).",
      "Strategic heifer rearing reduces the unproductive rearing phase, increasing lifetime herd profitability."
    ],
    "clinical": (
    ...
    "tables": [
      {
        "title": "Nutritional Phase Feeding Strategy for Growing Crossbred Dairy Heifers",
        "headers": ["Age / Phase", "Target Live Weight", "Daily ADG Target", "Ration Composition (Dry Matter Basis)", "Critical Veterinary Management Focus"],
        "rows": [
          ["3 to 6 Months (Weaning Transition)", "75 – 125 kg", "500 – 550 g/day", "60% Concentrate + 30% Green Legume + 10% Hay", "Rumen expansion; avoid coccidiosis; deworming"],
          ["6 to 12 Months (Prepubertal Phase)", "125 – 225 kg", "550 – 600 g/day", "40% Concentrate + 50% Green Fodder + 10% Straw", "Allometric mammary phase; strictly avoid over-conditioning"],
          ["12 to 18 Months (Breeding Phase)", "225 – 300 kg", "550 – 600 g/day", "25% Concentrate + 60% Green Fodder + 15% Straw", "Target 275–300 kg breeding weight; heat detection"],
          ["18 to 24 Months (Gestation Phase)", "300 – 425 kg", "500 – 550 g/day", "30% Concentrate + 50% Green Fodder + 20% Straw", "Support maternal frame growth + fetal gestation demands"]
        ]
      },
      {
        "title": "Economic Consequences of Heifer Growth Planes in Indian Dairying",
        "headers": ["Rearing Management Plane", "Daily Weight Gain (ADG)", "Age at Conception", "Age at First Calving (AFC)", "Lifetime Economic Return"],
        "rows": [
          ["Sub-Maintenance (Rural Straw Only)", "< 250 g / day", "30 – 36 Months", "40 – 48 Months", "High rearing cost; negative return; shortened productive life"],
          ["Optimal Scientific Feeding", "550 – 600 g / day", "15 – 18 Months", "24 – 27 Months", "Maximum lifetime milk yield; lowest lifetime rearing cost"],
          ["Excess Energy Overfeeding", "> 800 g / day", "11 – 13 Months", "20 – 22 Months", "Fat heifer syndrome; dystocia; 20% lower lifetime milk yield"]
        ]
      }
    ],
    "img": "",
    "tags": ["heifer nutrition", "allometric growth", "puberty", "age at first calving", "fat heifer syndrome", "dairy buffaloes", "ICAR 2013"]
  },

  "u3-t10": {
    "summary": "The transition period (3 weeks pre- to 3 weeks post-calving) dictates herd health, demanding lead feeding to adapt rumen papillae, precise DCAD to prevent hypocalcemia, and controlled energy to avoid fatty liver.",
    "desc": (
      "<b>I. THE CRITICAL TRANSITION (PERIPARTURIENT) PERIOD</b><br>"
      "The transition period is defined as the <b>3 weeks prior to calving through 3 weeks after calving</b>. Over 80% of all metabolic and infectious diseases of dairy cows and buffaloes (milk fever, ketosis, fatty liver, retained placenta, metritis, displaced abomasum) occur during this narrow 42-day window.<br><br>"
      "<b>The Physiological Paradox of the Transition Cow:</b><br>"
      "1. Fetal growth and colostrogenesis demand maximum nutrients.<br>"
      "2. Hormonal surges (estrogen peak near calving) and abdominal uterine crowding cause voluntary Dry Matter Intake (DMI) to plummet by <b>20% to 30%</b> in the final 10 days prepartum.<br>"
      "3. At calving, the sudden onset of copious milk secretion creates an instantaneous, massive metabolic demand for calcium, glucose, and amino acids.<br><br>"
      "<b>II. DRY PERIOD NUTRITIONAL MANAGEMENT (THE 60-DAY DRY PERIOD)</b><br>"
      "Dairy cows require a mandatory <b>60-day dry period</b> between lactations to allow:<br>"
      "<ul>"
      "<li>Senescent mammary epithelial cells to undergo apoptosis, autophagic involution, and regenerational renewal (a dry period <40 days reduces subsequent lactation milk yield by 20–25%).</li>"
      "<li>Restoration of maternal hepatic glycogen, skeletal muscle protein, and skeletal calcium-phosphorus reserves.</li>"
      "<li>Rumen mucosal recovery and papillae regeneration from previous high-concentrate lactation feeding.</li>"
      "</ul>"
    ...
    "keyPoints": [
      ...
      "Voluntary Dry Matter Intake (DMI) drops by 20-30% in the final 10 days before calving.",
      "A 60-day dry period is mandatory for mammary epithelial involution and renewal.",
      "Far-off dry period (60 to 21 days prepartum): feed high-fiber maintenance to keep BCS at 3.25-3.50.",
      "Cows entering calving with BCS >4.0 develop severe post-partum 'Fat Cow Syndrome' and ketosis.",
      "Close-up dry period (last 21 days): implement steaming-up / lead feeding (up to 3.0-3.5 kg concentrate).",
      "Lead feeding stimulates ruminal papillae expansion and adapts rumen microbes to starch.",
      "High potassium forages (berseem) induce metabolic alkalosis, blocking PTH receptors and causing milk fever.",
      "Negative DCAD diets (-50 to -100 mEq/kg DM) using anionic salts induce mild acidosis and prevent milk fever.",
      "Bovine liver has low VLDL export capacity; excess NEFA accumulation causes hepatic lipidosis (fatty liver)."
    ],
    "clinical": (
    ...
    "tables": [
      {
        "title": "The Four Distinct Nutritional Phases of the Dairy Cow Lactation Cycle",
        "headers": ["Lactation Phase", "Time Window", "Energy Balance Status", "Target Ration Specifications", "Primary Nutritional Goal"],
        "rows": [
    ...
    "img": "",
    "tags": ["transition period", "dry cow management", "lead feeding", "steaming up", "DCAD", "milk fever", "fatty liver", "urine pH"]
  },

  "u3-t11": {
    "summary": "Breeding bulls demand moderate conditioning with elevated zinc and vitamin A to sustain libido and spermatogenesis, while working bullocks require easily digestible carbohydrates and electrolytes for tractive power.",
    "desc": (
      "<b>I. NUTRITIONAL MANAGEMENT OF BREEDING BULLS</b><br>"
      "Breeding bulls (artificial insemination studs and natural service sires) represent 50% of the genetic improvement of a herd. Nutritional management must sustain high libido, aggressive mounting vigor, and maximum daily production of viable, morphologically normal spermatozoa with high freeze-thaw survival.<br><br>"
      "<b>Body Condition and Energy Balance:</b><br>"
      "<ul>"
      "<li><b>The Peril of Obesity:</b> Bulls must be maintained in athletic, lean working condition (<b>target BCS 3.0 on a 1–5 scale</b>). Overfeeding energy creates scrotal fat deposition in the neck of the scrotum. This insulates the testicular vascular cone (*pampiniform plexus*), preventing the mandatory 2–4°C counter-current cooling of the testes below core body temperature. Testicular thermal degeneration ensues, producing high percentages of abnormal sperm (bent tails, proximal cytoplasmic droplets, detached heads) and irreversible infertility.</li>"
      "<li>Excess weight also causes arthritis of the hocks and stifle joints, making bulls reluctant to mount the dummy cow in AI collection arenas.</li>"
      "<li><b>Nutritional Regimen:</b> Adult bulls require maintenance energy + 10–15% buffer for semen collection activity (approx. 2.0–2.5 kg balanced concentrate + 20 kg cultivated green fodder + ad libitum dry straw).</li>"
      "</ul>"
      ...
      "In contrast to breeding bulls (where micronutrient quality and lean maintenance dominate), working bullocks require substantial quantitative energy to power muscular contraction during agricultural field operations (plowing, harrowing, carting). Concentrate feeds high in digestible non-structural carbohydrates (crushed maize, barley, wheat bran, molasses) provide rapid hepatic glycogen replenishment and circulating acetate/propionate."
    ),
    "eliteDesc": (
      "<b>Testicular Thermoregulation and Scrotal Adiposity:</b><br>"
      "Normal bovine spermatogenesis requires an intratesticular temperature strictly maintained at 33.0°C to 34.5°C (compared to 38.5°C core rectal temperature). This gradient is maintained by: (1) active sweat gland evaporation on the thin scrotal skin; (2) contraction/relaxation of the *tunica dartos* and *cremaster* muscles; and (3) the counter-current heat exchange mechanism of the *pampiniform plexus*, where warm testicular arterial blood transfers heat to cool venous blood draining the testes. Scrotal neck fat accumulation acts as an impermeable thermal jacket, collapsing this counter-current gradient. Intratesticular hypoxia and reactive oxygen species (ROS) destroy primary spermatocytes and spermatids during meiotic division."
    ),
    "keyPoints": [
      "Breeding bulls must be maintained in lean, muscular condition (BCS 3.0); obesity causes infertility.",
      "Scrotal fat insulation destroys counter-current testicular cooling (normally 2-4°C below body temperature).",
      "Thermal testicular degeneration produces high percentages of abnormal sperm and poor motility.",
      "Zinc is essential for spermatogenesis, testosterone synthesis, and sperm chromatin condensation.",
      "Vitamin A maintains seminiferous tubule epithelium; deficiency causes aspermia and germ cell sloughing.",
      "Selenium and Vitamin E protect PUFA-rich sperm cell membranes from lipid peroxidation.",
      "Adult breeding bulls require maintenance + 15% energy buffer, satisfied by 2.0-2.5 kg concentrate + greens.",
      "Working bullocks require energy-dense rations (maize, molasses, brans) to support muscular work.",
      "Working bullocks do not require excess protein; excess protein increases urea excretion and heat stress.",
      "Salt supplementation (50-80 g/day) is essential for working bullocks to replace electrolyte losses in sweat."
    ],
    "clinical": (
      "<b>Nutritional Investigation of Subfertile AI Sires at Semen Stations:</b><br>"
      "At central AI bull stations (e.g. SAG-Bidaj or NDDB semen stations), a frequent clinical complaint is sudden deterioration of semen freezing quality in Murrah or Sahiwal bulls during summer months (post-thaw motility dropping <35%, high acrosomal defects). Investigation often reveals that over-conditioned bulls (BCS >4.0) fed excess concentrate without exercise developed scrotal fat accumulation combined with environmental heat stress. Corrective clinical protocol: (1) Reduce concentrate by 25% and replace starchy grains with high-fiber wheat bran; (2) Daily mandatory exercise on mechanical bull exercisers for 45 minutes; (3) Supplemental organic zinc-methionine (200 mg Zn/day) and Vitamin E (1000 IU/day). Semen quality rebounds within 60 days (the duration of one bovine spermatogenic cycle)."
    ),
    "tables": [
      {
        "title": "Nutritional and Management Distinctions: Breeding Bulls vs Working Bullocks",
        "headers": ["Parameter / Management Criterion", "Breeding Bull (AI Stud / Sire)", "Working Draft Bullock (Field / Plowing)"],
        "rows": [
          ["Target Body Condition Score (BCS)", "Strictly 3.0 (Athletic, lean, vigorous)", "3.0 to 3.25 (Well-muscled, robust energy reserves)"],
      ...
      },
      {
        ...
        "rows": [
          ...
          ["Common Salt (NaCl)", "40 g", "~ 40 g DM", "Maintains fluid osmotic balance and saliva secretion"]
        ]
      }
    ],
    "img": "",
    "tags": ["breeding bull nutrition", "working bullocks", "spermatogenesis", "zinc", "vitamin A", "scrotal thermoregulation", "testicular degeneration"]
  },
  ...
  "u3-t12": {
    ...
    "desc": (
      ...
      "<b>Definition:</b> The practice of increasing the plane of nutrition of ewes <b>2 to 3 weeks prior to mating (ram introduction)</b> and continuing for 1 to 2 weeks into the breeding season.<br>"
      "<b>Method:</b> Supplementing grazing ewes with <b>200 to 300 g of cereal grains (maize/barley) or concentrate mixture daily</b>, or moving them onto lush green cultivated pastures.<br>"
      "<b>Biological Response:</b> Elevates systemic blood glucose and insulin levels, triggering follicular development in the ovaries. Increases ovulation rate by 15% to 30%, reduces early embryonic mortality, concentrates the lambing season into a tight 3-week window, and dramatically increases twinning percentages in prolific breeds (e.g. Garole, Malpura, Kendrapada).</li>"
      "<li><b>2. Early and Mid-Gestation (First 15 Weeks):</b> Fetal growth is minimal. Ewes should be maintained on standard grazing with zero weight loss. Avoid sudden nutritional changes.</li>"
      "<li><b>3. Steaming Up (Late Gestation - Final 4 to 6 Weeks):</b> Over 70% of fetal growth occurs now. Ewes carrying twins or triplets have double the nutritional demand while the gravid uterus severely compresses the rumen. Feed <b>300 to 400 g of balanced concentrate daily</b> alongside good green fodder. Prevents <b>Pregnancy Toxaemia (Twin Lamb Disease)</b> and guarantees high birth weight (>2.5 kg).</li>"
      ...
      "<li>Accelerates daily growth rate (150–200 g/day), stimulates rapid ruminal papillae development, and permits early weaning at 60–90 days with slaughter weights of 22–25 kg.</li>"
      "</ul>"
    ),
    "eliteDesc": (
    ...
    "keyPoints": [
      ...
      "Flushing is feeding extra concentrate (200-300 g/day) 2-3 weeks before mating to boost ovulation.",
      "Flushing increases twinning rates by 15-30% and synchronizes the estrus and lambing window.",
      "Steaming up during the last 4-6 weeks of gestation provides 300-400 g concentrate to prevent twin lamb disease.",
      "Ewes reach peak milk production at 3-4 weeks; twin-rearing ewes demand 600-750 g concentrate daily.",
      "Creep feeding provides an exclusive high-protein (18-20% CP) diet to suckling lambs from 2 weeks of age.",
      "Creep feeding accelerates lamb growth (150-200 g/day), enabling weaning at 60-90 days.",
      "Copper toxicity risk: sheep are exceptionally sensitive to excess copper; liver stores Cu until crisis.",
      "Dietary copper in sheep must not exceed 10-15 ppm, with minimum 1-2 ppm molybdenum to prevent toxicity.",
      "Top feeds (Khejri *Prosopis cineraria*, *Acacia nilotica*) provide critical protein during semi-arid summers."
    ],
    "clinical": (
    ...
    "tables": [
      {
        "title": "Phase-Wise Feeding Schedule for Breeding Ewes (Adult 40 kg Body Weight)",
      ...
      {
        "title": "Formulation and Nutrient Specifications of Sheep Creep and Grower Rations",
        "headers": ["Ingredient / Specification", "Creep Feed (10 Days to Weaning)", "Lamb Grower Feed (Weaning to 6 Months)", "Adult Maintenance Mix"],
        "rows": [
          ["Crushed Maize / Barley Grain", "45.0 %", "40.0 %", "30.0 %"],
          ["Soybean Meal / Mustard Cake", "32.0 % (High bypass protein)", "25.0 %", "18.0 %"],
          ["Wheat Bran / Rice Polish", "13.0 %", "24.0 %", "42.0 %"],
          ["Liquid Cane Molasses", "7.0 % (High palatability)", "8.0 %", "7.0 %"],
          ["Sheep Mineral Mixture (Low Cu)", "2.0 %", "2.0 %", "2.0 %"],
          ["Common Salt (NaCl)", "1.0 %", "1.0 %", "1.0 %"],
          ["Calculated Crude Protein (CP)", "20.5 % CP", "17.0 % CP", "14.0 % CP"],
          ["Calculated Total Digestible Nutrients", "76.0 % TDN", "72.0 % TDN", "66.0 % TDN"]
        ]
      }
    ],
    "img": "",
    "tags": ["sheep nutrition", "flushing", "steaming up", "creep feeding", "copper toxicity", "twin lamb disease", "ICAR sheep"]
  },

  "u3-t13": {
    "summary": "Goats are agile, selective browsers with prehensile lips and high dry matter intake capacity (3.5-5.0% BW), excelling on tannin-rich tree leaves and demanding high energy to sustain rapid growth and twinning.",
    "desc": (
      ...
      "<li><b>Tannin Tolerance:</b> Goat saliva contains rich concentrations of proline-rich proteins and unique ruminal microbes (*Streptococcus gallolyticus*) that bind and neutralize dietary condensed tannins, allowing goats to thrive on tree leaves (e.g. *Acacia nilotica*, *Prosopis cineraria*, *Leucaena leucocephala*) that would intoxicate or inhibit digestion in cattle.</li>"
      "</ul>"
      "<b>II. PHASE FEEDING OF MEAT (CHEVON) AND DAIRY GOATS</b><br>"
      "<ul>"
      "<li><b>1. Meat Goats (Black Bengal, Sirohi, Barbari, Boer):</b> Intensive fattening of kids for premium quality chevon. Kids are offered creep feed from 2 weeks of age. Post-weaning fattening rations (16% CP, 70% TDN) achieve 100–150 g ADG, reaching the ideal market slaughter weight of 15–18 kg by 6 to 7 months of age with a dressing percentage of 48–52%.</li>"
      "<li><b>2. Dairy Goats (Jamunapari, Beetal, Saanen):</b> Yield 2 to 4 liters of milk daily. Milk contains small fat globules that are naturally homogenized and easily digested. Supply maintenance + 1 kg concentrate for every 2.0 liters of milk.</li>"
      "<li><b>3. Prolificacy and Twinning Management:</b> In prolific breeds like Black Bengal (twinning/triplet rate >80%), late gestation and early lactation demand intensive concentrate supplementation (250–350 g/day) to prevent maternal hypoglycemia.</li>"
      "</ul>"
      "<b>III. USE OF TREE LEAVES ('TOP FEEDS') IN GOAT NUTRITION</b><br>"
    ...
    "keyPoints": [
      ...
      "Prehensile lips and bifurcated upper lip permit selective harvesting of nutritious leaf tips.",
      "Goats display bipedal stance, browsing tree leaves up to 2 meters above the ground.",
      "Voluntary Dry Matter Intake (DMI) is exceptionally high: 3.5% to 5.0% of body weight daily.",
      "Proline-rich saliva and specialized ruminal bacteria provide high tolerance to dietary tannins.",
      "Black Bengal goats are highly prolific (>80% twins/triplets), demanding intensive late pregnancy feed.",
      "Chevon (goat meat) kids require creep feeding to achieve 15-18 kg market weight by 6 months.",
      "Goat milk contains small fat globules, providing superior digestibility for human convalescents.",
      "Top feeds (Khejri, Subabul, Ber, Neem) supply vital crude protein during semi-arid summers.",
      "Subabul (*Leucaena*) contains toxic mimosine; native goats degrade it via ruminal *Synergistes jonesii*."
    ],
    "clinical": (
    ...
    "tables": [
      {
        "title": "Anatomical, Behavioral and Nutritional Contrasts: Goats vs Sheep",
        "headers": ["Characteristic / Parameter", "Domestic Goat (Capra hircus)", "Domestic Sheep (Ovis aries)", "Nutritional & Management Meaning"],
        "rows": [
          ["Feeding Classification", "Obligate Browser (Top feeds, bushes)", "Obligate Grazer (Short grasses, pasture)", "Goats browse high-tannin foliage; sheep graze low pastures"],
          ["Mouth Anatomy", "Prehensile mobile lips; bifurcated upper lip", "Cleft upper lip; blunt muzzle", "Goats strip leaves from thorns; sheep crop close to roots"],
          ["Dry Matter Intake (DMI)", "3.5 – 5.0 % of Body Weight", "3.0 – 3.8 % of Body Weight", "Goats have faster passage rate and higher intake capacity"],
          ["Tannin Tolerance", "High (Proline-rich saliva, *S. gallolyticus*)", "Moderate to low", "Goats utilize tree leaves rejected by sheep and cattle"],
          ["Water Economy", "Exceptional; concentrated urine & dry faeces", "Good water economy", "Goats endure longer watering intervals in arid desert zones"],
          ["Copper Tolerance", "High (Requires 15–25 ppm Cu in diet)", "Extremely low (Toxicity at >15 ppm Cu)", "Cattle feed is safe for goats, but fatal to sheep"]
        ]
      },
      {
        "title": "Nutritive Value of Common Indian Tree Leaves ('Top Feeds') for Goats",
        "headers": ["Botanical Name", "Common Indian Name", "Dry Matter (%)", "Crude Protein (CP %)", "TDN (%)", "Anti-Nutritional Factor (ANF)"],
        "rows": [
          ["Prosopis cineraria", "Khejri / Loom", "45 – 50 %", "12.0 – 14.5 %", "48 – 52 %", "Condensed tannins (6–8%); bind protein"],
          ["Leucaena leucocephala", "Subabul", "28 – 32 %", "20.0 – 24.0 %", "62 – 66 %", "Mimosine (Toxic amino acid; limit to <30%)"],
          ["Acacia nilotica", "Babul", "40 – 45 %", "11.0 – 13.0 %", "50 – 55 %", "Hydrolyzable & condensed tannins in leaves & pods"],
          ["Ziziphus mauritiana", "Ber / Pala", "35 – 40 %", "13.0 – 15.0 %", "54 – 58 %", "Moderate tannins; highly palatable to goats"],
          ["Azadirachta indica", "Neem", "30 – 35 %", "14.0 – 16.0 %", "52 – 56 %", "Bitter triterpenoids (Azadirachtin; natural dewormer)"]
        ]
      }
    ],
    "img": "",
    "tags": ["goat nutrition", "browsing behavior", "tannin tolerance", "top feeds", "khejri", "subabul", "enterotoxaemia", "chevon"]
  },
  ...
  "u3-t14": {
    ...
    "desc": (
      ...
      "<ul>"
      "<li><b>1. Prepartum Phase (Steaming Up):</b> Starting 2 to 3 weeks before the expected calving date, introduce 1.0 to 1.5 kg of lactation concentrate, increasing gradually by 0.5 kg every 3 to 4 days until the cow is consuming <b>3.0 to 3.5 kg concentrate daily</b> at calving (approx. 0.5 to 0.75 kg concentrate per 100 kg body weight). This expands ruminal absorptive papillae and adapts amylolytic bacteria to starch.</li>"
      "<li><b>2. Postpartum Phase (The Challenge):</b> After calving, begin feeding according to actual milk yield plus an extra <b>0.5 kg of concentrate every 2 to 3 days</b>. Continue challenging the cow with additional concentrate as long as she responds with an increase in milk yield that pays for the extra feed. Once milk yield plateaus and fails to rise in response to additional concentrate, reduce the feed to match her actual production standard.</li>"
      "</ul>"
      "<b>III. TOTAL MIXED RATION (TMR) SYSTEM</b><br>"
      "In high-yielding herds, feeding concentrates and roughages separately (e.g. concentrate in milking parlor, straw in the yard) is disastrous: cows gorge on concentrate, causing ruminal pH to crash cyclically below 5.5.<br><br>"
      "<b>The TMR Solution:</b><br>"
      "A <b>Total Mixed Ration (TMR)</b> is the practice of blending all dietary ingredients—chaffed roughages, green forages, silage, grains, protein meals, bypass nutrients, minerals, and vitamins—into an intimate, uniform, complete mix fed ad libitum.<br>"
      "<b>Cardinal Benefits of TMR:</b><br>"
      "<ul>"
      "<li>Prevents selective sorting of grains over coarse roughages.</li>"
      "<li>Guarantees that every bite contains an identical, optimal Roughage-to-Concentrate ratio.</li>"
      "<li>Maintains continuous, steady-state ruminal microbial fermentation, stabilizing rumen pH at <b>6.2 to 6.6</b> throughout the 24-hour cycle.</li>"
      "<li>Increases total daily DMI by 10% to 15% and eliminates clinical Subacute Ruminal Acidosis (SARA).</li>"
      "</ul>"
    ),
    "eliteDesc": (
    ...
    "keyPoints": [
      ...
      "Challenge feeding gradually increases concentrate prepartum and postpartum to discover genetic peak.",
      "Prepartum lead feeding (3 weeks pre-calving) builds concentrate to 3.0-3.5 kg/day at calving.",
      "Lead feeding stimulates elongation of ruminal papillae, expanding VFA absorptive surface area.",
      "Postpartum challenge increases concentrate by 0.5 kg every 2-3 days until milk yield plateaus.",
      "Total Mixed Ration (TMR) blends all roughages, concentrates, and minerals into a single uniform mix.",
      "TMR prevents cows from selectively sorting grains and eliminates postprandial ruminal pH crashes.",
      "TMR stabilizes rumen pH at 6.2-6.6, maximizing cellulolytic bacterial digestion and milk fat %.",
      "High yielders require minimum 21% physically effective NDF (peNDF) to stimulate cud-chewing.",
      "Bypass fat (calcium soaps) and bypass protein are mandatory ingredients in high-yield TMR diets."
    ],
    "clinical": (
    ...
    "tables": [
      {
        "title": "Challenge Feeding Schedule for a 400 kg High-Yielding Dairy Cow",
        "headers": ["Timeline / Phase", "Lactation Status", "Daily Concentrate Allowance", "Roughage Allowance", "Management Objective"],
        "rows": [
          ["Day -21 to Day -14", "Far-Off Dry Cow", "1.0 – 1.5 kg / day", "Ad libitum straw + 15 kg greens", "Initiate microbial adaptation to starch"],
          ["Day -14 to Day -7", "Close-Up Transition", "2.0 – 2.5 kg / day", "Chaffed straw + 10 kg greens", "Stimulate ruminal papillae elongation"],
          ["Day -7 to Day 0", "Immediate Prepartum", "3.0 – 3.5 kg / day", "Chaffed straw + 5 kg greens", "Achieve target rumen absorption capacity"],
          ["Day 1 to Day 14", "Postpartum Fresh Cow", "Match yield + 0.5 kg every 3 days", "High quality greens + hay TMR", "Challenge for genetic peak milk yield"],
          ["Day 15 to Day 45", "Peak Milk Challenge", "Continue challenging until yield plateaus", "Balanced TMR (50:50 R:C ratio)", "Lock in peak milk yield; maintain BCS >2.75"]
        ]
      },
      {
        "title": "Comparison: Conventional Component Feeding vs Total Mixed Ration (TMR)",
        "headers": ["Evaluation Criterion", "Conventional Component Feeding", "Total Mixed Ration (TMR) System"],
        "rows": [
          ["Feeding Method", "Concentrates fed separately in parlor; roughages in open yard", "All roughages, concentrates, minerals thoroughly blended together"],
          ["Dietary Sorting", "Extensive; cows eagerly sort grains and reject coarse fiber", "Eliminated; every bite has an identical nutrient balance"],
          ["Rumen pH Dynamics", "Violent swings; pH crashes below 5.5 after each grain meal", "Extremely stable; maintains steady pH between 6.2 and 6.6"],
          ["Cellulolytic Digestion", "Sub-optimal; fiber-digesting bacteria inhibited by acid surges", "Maximized; steady microbial fermentation of structural fiber"],
          ["Incidence of SARA", "High; frequent laminitis, solar ulcers, and milk fat depression", "Extremely low; preserves rumen epithelial integrity"],
          ["Labor & Automation", "High manual labor in feeding individual cows multiple times", "Mechanized via TMR wagon mixers; highly labor-efficient"]
        ]
      }
    ],
    "img": "",
    "tags": ["high yielding cows", "challenge feeding", "lead feeding", "TMR", "total mixed ration", "SARA", "rumen papillae", "peak lactation"]
  },
  ...
  "u3-t15": {
    ...
    "desc": (
      ...
      "<li><b>2. Heat Treatment & Roasting:</b> Roasting soybeans or cereal grains at 140–150°C for 30 minutes induces the Maillard reaction between free sugars and amino groups, rendering protein insoluble at ruminal pH.</li>"
      "</ul>"
      "<b>III. RUMEN PROTECTED FAT (BYPASS FAT)</b><br>"
    ...
    "keyPoints": [
      ...
      "Dietary protein consists of Rumen Degradable Protein (RDP) and Rumen Undegradable Protein (RUP).",
      "Formaldehyde treatment (1.0-1.2 g HCHO per 100 g CP) forms pH-dependent methylene cross-links.",
      "Methylene cross-links resist neutral rumen pH (6.5) but hydrolyze in the acidic abomasum (pH 2.2).",
      "Bypass protein delivers limiting amino acids (Methionine and Lysine) directly to the duodenum.",
      "Unprotected free dietary fat (>4% of DM) coats fiber particles and kills cellulolytic bacteria.",
      "Calcium salts of fatty acids (Ca-LCFA / Calcium soaps) are insoluble in rumen but dissociate in abomasum.",
      "Prill fats are fractionated saturated palmitic triglycerides (C16:0) that boost milk fat percentage.",
      "Feeding 200-300 g bypass fat daily increases energy density without depressing fiber digestion.",
      "Bypass nutrients increase milk yield (1.5-2.5 L/day), milk fat %, and improve postpartum fertility."
    ],
    "clinical": (
    ...
    "tables": [
      ...
      {
        "title": "Production Responses to Bypass Nutrients in Indian Dairy Animals (IVRI / NDDB Trials)",
        "headers": ["Supplementation Regimen", "Target Animal Category", "Typical Daily Dose", "Observed Production & Reproductive Benefits"],
        "rows": [
          ["Formaldehyde-Treated Mustard Cake", "Murrah Buffaloes (>10 L Milk)", "1.0 – 1.5 kg / day", "+ 1.2 to 1.8 L milk/day; + 0.4% milk fat; reduced days open"],
          ["Calcium Salts of Fatty Acids (Ca-LCFA)", "Crossbred Dairy Cows (Early Lactation)", "200 – 300 g / day", "+ 1.5 to 2.2 L milk/day; reduced postpartum body weight loss"],
          ["Fractionated Palmitic Prill Fat (C16:0)", "High-Yielding Dairy Cows / Buffaloes", "150 – 250 g / day", "+ 0.5 to 0.8% increase in butterfat content; prevents MFD"],
          ["Rumen-Protected Methionine (RPM)", "Intensive High-Yield Herds (>25 L)", "15 – 25 g / day", "+ 0.2% milk protein; reduces hepatic lipidosis and ketosis"]
        ]
      }
    ],
    "img": "",
    "tags": ["bypass nutrients", "bypass protein", "bypass fat", "RUP", "formaldehyde treatment", "calcium soaps", "prill fat", "NDDB"]
  },
  ...
  "u3-t16": {
    ...
    "desc": (
      ...
      "<ul>"
      "<li><b>1. Maximum Inclusion Limits:</b><br>"
    ...
    "clinical": (
      ...
      "A classical emergency in Indian veterinary practice occurs when a farmer leaves open a bag of agricultural fertilizer urea (IFFCO 46% N) in the cattle shed. Cows lick the damp, sweet-salty urea granules. Within 45 minutes, multiple cows exhibit staggering gait, frothy salivation, violent muscle tremors, and tympanites. The veterinarian must act instantly without waiting for lab confirmation: pass a stomach tube, pump in 20 liters of cold tubewell water mixed with 2 bottles (1.5 L) of synthetic table vinegar per cow. Animals treated within 30 minutes of clinical onset recover completely as rumen pH drops to 6.0 and ammonium absorption ceases."
    ),
    "tables": [
      {
        "title": "Cardinal Rules and Safety Boundaries for Urea Inclusion in Ruminant Feeds",
      ...
      {
        "title": "Emergency Diagnostic and Treatment Protocol for Acute Ammonia Toxicosis",
    ...
    "img": "",
    "tags": ["NPN", "urea feeding", "microbial protein", "urea toxicity", "ammonia toxicosis", "vinegar therapy", "golden rules"]
  },

  "u3-t17": {
    "summary": "Metabolic disorders (ketosis, milk fever, ruminal acidosis, bloat) represent physiological failures to manage nutritional transitions, requiring targeted dietary interventions: glucogenic precursors, DCAD, buffers, and anti-foaming agents.",
    "desc": (
    ...
    "keyPoints": [
      ...
      "Ketosis signs: sweet acetone breath odor, anorexia for grain, rapid weight loss, waxy dung.",
      "Ketosis treatment: IV 50% dextrose + oral propylene glycol (300 g twice daily for 5 days).",
      "Milk fever is acute hypocalcemia (<5.0 mg/dL) at calving causing flaccid skeletal paralysis.",
      "Milk fever hallmark: sternal recumbency with lateral kink or head turned into flank ('S' curve).",
      "Milk fever treatment: slow IV infusion of 450 mL 25% Calcium Borogluconate under cardiac auscultation.",
      "Lactic acidosis occurs when grain engorgement drives *Streptococcus bovis* to produce lactic acid (pH <5.0).",
      "Acidosis damages ruminal wall, causing chemical rumenitis, dehydration, and liver abscesses.",
      "Frothy bloat is stable foam trapping fermentation gas, triggered by soluble proteins in lush berseem/clover.",
      "Bloat treatment: anti-foaming surfactants (vegetable/mineral oil, poloxalene); emergency left trocarization."
    ],
    "clinical": (
    ...
    "tables": [
      {
        "title": "Comprehensive Diagnostic Matrix: Major Ruminant Metabolic Disorders",
        "headers": ["Metabolic Disorder", "Primary Biochemical Derangement", "Key Predisposing Dietary Factor", "Pathognomonic Clinical Sign", "Immediate Therapeutic Intervention"],
        "rows": [
      ...
      {
        "title": "Nutritional Prevention Strategies for Dairy Herd Metabolic Disorders",
        "headers": ["Disorder", "Dietary Preventive Measure", "Inclusion Rate / Specification", "Biochemical Mechanism of Prevention"],
        "rows": [
    ...
    "img": "",
    "tags": ["metabolic disorders", "ketosis", "milk fever", "ruminal acidosis", "bloat", "calcium borogluconate", "DCAD", "propylene glycol"]
  }
}

target_file = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "data-theory-unit3.JS")

with open(target_file, "w", encoding="utf-8") as f:
    f.write("/* Auto-scaffolded and compiled by tools/build_unit3.py — safe to edit by hand. */\n")
    f.write("var theoryData = (typeof theoryData !== 'undefined') ? theoryData : {};\n\n")
    f.write('theoryData["unit-3"] = ')
    json.dump(unit3_data, f, indent=2, ensure_ascii=False)
    f.write(";\n")

print(f"Successfully generated {target_file} with {len(unit3_data)} topics.")
