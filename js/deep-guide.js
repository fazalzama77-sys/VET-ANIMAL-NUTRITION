...
(() => {
    ...
    const DEEP_STORAGE_KEY = 'vanut-deep-guide-seen';
    let deepGuide = null;
    let observer = null;
    let checkTimer = null;
    ...
    const showDeepGuide = () => {
        ...
        deepGuide.innerHTML = `
            ...
            <div class="deep-guide-kicker"><i class="fas fa-seedling"></i> TWO LEVELS OF DETAIL</div>
            <h2>Unlock Deep Nutritional View</h2>
            <p>Tap <strong>Deep View</strong> for comprehensive biochemical pathways, feed processing flowcharts, bioenergetics, and ration formulation guidelines.</p>
...
(() => {
    ...
    const TOPIC_STORAGE_KEY = 'vanut-topic-guide-seen';
    let topicGuide = null;
    let checkTimer = null;
