...
var app = (function () {
  ...
  function normHl(h) {
    ...
    return { text: h.text || "", color: col, occ: (typeof h.occ === "number" && h.occ >= 0) ? h.occ : 0 };
  }
  ...
  function _initLandingCanvas() {
    ...
    function renderLoop() {
      ...
      if (width > 600) {
        ...
        ctx.fillText("ANIMAL_NUTRITION_STUDIO // UNITS_1_4_ONLINE", width - 240, txtY + 13);
      }
  ...
  var SPOTTERS_OF_THE_DAY = [
    {
      ...
      unitId: "unit-3",
      topicId: "u3-t17",
      badge: "Nutritional Metabolic Disorder"
    },
    {
      name: "Acute Ruminal Acidosis (Grain Overload / Lactic Acidosis)",
      organ: "Rumen & Systemic Circulation (Bovine / Ovine)",
      etiology: "Ingestion of excessive rapidly fermentable carbohydrates (wheat, maize, barley, molasses) leading to Streptococcus bovis explosion and D-/L-lactic acid accumulation.",
      gross: "Severe ruminal distension with fluid-splashing sounds on ballottement, watery sweet-sour fetid diarrhea, sunken eyes (severe dehydration), ataxia, and recumbency.",
      micro: "Ruminal fluid pH drops below 5.0; ruminal papillae exhibit hydropic degeneration, vesicle formation, and coagulative necrosis with mucosal sloughing.",
      viva: "Rumen protozoa perish below pH 5.5; Gram-positive rods (Lactobacillus) replace Gram-negative cellulolytics. High D-lactate causes severe systemic metabolic acidosis. Emergency therapy: gastric lavage, oral magnesium hydroxide / sodium bicarbonate, and transfaunation.",
      unitId: "unit-3",
      topicId: "u3-t17",
      badge: "Ruminal Fermentation Crisis"
    },
    {
      name: "Pregnancy Toxaemia (Twin Lamb Disease)",
      organ: "Liver & Brain (Ovine)",
      etiology: "Inability of late-gestation ewe bearing twin/triplet fetuses to meet enormous fetal glucose demands under restricted ruminal capacity.",
      gross: "Affected ewes separate from flock, exhibit apparent blindness, muscle tremors, star-gazing, teeth grinding, sternal recumbency, and coma. Liver is enlarged, pale yellow, and greasy.",
      ...
      viva: "Blood glucose plunges below 20-30 mg/dL while plasma BHBA exceeds 2.5-3.0 mmol/L. Fetus consumes up to 70% of maternal glucose. Treatment is urgent oral glycerol/propylene glycol, IV dextrose, and immediate caesarean section if near term.",
      unitId: "unit-3",
      topicId: "u3-t17",
      badge: "Ovine Metabolic Crisis"
    },
    {
      name: "Parturient Hypocalcemia (Milk Fever)",
      organ: "Neuromuscular Junction & Skeleton (Dairy Cattle)",
      etiology: "Acute failure of calcium homeostatic mechanisms (PTH and calcitriol) to match sudden calcium drain into colostrum at the onset of lactation.",
      gross: "Stage 1: restlessness, hypersensitivity; Stage 2: sternal recumbency with characteristic 'S-shaped' neck curvature or head turned into flank, dry muzzle, cold ears/extremities; Stage 3: flaccid paralysis and coma.",
      micro: "Severe hypocalcemia (serum Ca < 5 mg/dL; normal 9-11 mg/dL) with secondary hypophosphatemia. Blockade of acetylcholine release at motor end-plates causing flaccid paresis.",
      viva: "Prevented by anionic salts in late dry period to achieve negative DCAD (-50 to -100 mEq/kg DM), stimulating bone Ca resorption and renal 1-alpha-hydroxylase. Emergency treatment: 400-500 mL IV 25% calcium borogluconate slowly under cardiac monitoring.",
      unitId: "unit-3",
      topicId: "u3-t17",
      badge: "Macro-Mineral Metabolic Crisis"
    },
    {
      name: "Urea Toxicity & Ammonia Intoxication",
      organ: "Rumen & Central Nervous System (Ruminants)",
      etiology: "Excessive or unadapted consumption of feed-grade urea (>0.45 g/kg body weight or >3% of concentrate mixture) overwhelming ruminal urease capacity and hepatic urea cycle.",
      gross: "Rapid onset (20-60 min): severe restlessness, salivation, teeth grinding, abdominal pain, muscle tremors, incoordination, bloat, dyspnea, violent tetanic convulsions, and death.",
      micro: "Rumen fluid pH > 8.0 with intense pungent ammoniacal odor. Blood ammonia exceeds 1.0-2.0 mg/dL (normal < 0.2 mg/dL), crossing blood-brain barrier and inhibiting Krebs cycle and glutamine synthesis.",
      viva: "Golden rule for urea feeding: maximum 1% of total dry matter or 3% of concentrate mixture; must provide readily fermentable starch (molasses/grain) and adequate sulfur (N:S ratio 10:1). Emergency treatment: 2-8 liters of 5% acetic acid (vinegar) in 20-30 liters of cold water infused into rumen.",
      unitId: "unit-3",
      topicId: "u3-t16",
      badge: "NPN Toxicity & Safe Feeding"
    },
    {
  ...
  function renderHome() {
    ...
    var rankTitle = "Nutrition Apprentice";
    if (masteryXp >= 750) rankTitle = "Master Animal Nutritionist";
    else if (masteryXp >= 500) rankTitle = "Senior Ration Formulator";
    else if (masteryXp >= 250) rankTitle = "Junior Feed Analyst";
    ...
    var termKeys = Object.keys((window.glossary && glossary.terms) || {});
    var dailyTermKey = termKeys.length ? termKeys[dayOfYear % termKeys.length] : "proximate analysis";
    var dailyTermDef = (window.glossary && glossary.terms[dailyTermKey]) || "Systematic chemical partitioning of feedstuffs into moisture, crude protein, ether extract, crude fibre, total ash, and nitrogen-free extract (NFE).";

    // Prioritize resume card message
    var resumeIcon = "theory";
    var resumeTitle = "Ready to start studying?";
    var resumeSubtitle = "Begin with Unit 1: Principles of Animal Nutrition and Feed Technology.";
    ...
    if (q.incorrect && q.incorrect.length > 0) {
      ...
      resumeSubtitle = "Reinforce weak spots and master tricky animal nutrition questions.";
    ...
    view.innerHTML =
      ...
      '<div class="home-scholar-bar">' +
        '<div class="home-scholar-greeting">' +
          ...
          '<p class="home-greeting-sub">Animal Nutrition Studio · B.V.Sc &amp; A.H. Year 2 · VCI MSVE 2016</p>' +
        '</div>' +
      ...
      '<section class="hero">' +
        ...
        '<div class="hero__inner">' +
          ...
          '<h1 class="hero__title">Animal Nutrition<br><span class="hero__title-accent">Studio</span></h1>' +
          '<p class="lede hero__lede">Four theory units, four practical units, a question bank and an interactive quiz engine — ' +
      ...
      '<div class="home-actions-grid">' +
        '<a class="home-action-tile" href="#/quiz/grand">' +
          ...
          '<p class="action-tile-desc">Instant randomized 10-question animal nutrition sprint with real-time scoring.</p>' +
        ...
        '<a class="home-action-tile" href="#/practical">' +
          ...
          '</div>' +
          '<h3 class="action-tile-title">Feed Tech &amp; Practical Hub</h3>' +
          '<p class="action-tile-desc">Feed microscopy, proximate analysis, silage making &amp; ration balancing.</p>' +
      ...
      /* 4. Nutrition Spotter of the Day (Nutritional Disorder Spotlight) */
      '<div class="home-spotter-card">' +
        '<div class="spotter-header">' +
          '<div>' +
            '<span class="spotter-eyebrow">' + icon("sparkle") + ' ANIMAL NUTRITION SPOTTER OF THE DAY · ' + esc(spotter.badge) + '</span>' +
        ...
        '<div class="spotter-gross-box">' +
          '<h4>' + icon("eye") + ' Cardinal Clinical &amp; Nutritional Hallmark</h4>' +
        ...
        '<div id="spotter-details-drawer" class="spotter-details-drawer">' +
          '<div class="spotter-details-grid">' +
            '<div class="spotter-detail-item">' +
              '<h5>' + icon("pulse") + ' Primary Etiology &amp; Metabolic Mechanism</h5>' +
              '<p>' + esc(spotter.etiology) + '</p>' +
            '</div>' +
            '<div class="spotter-detail-item">' +
              '<h5>' + icon("microscope") + ' Pathophysiological &amp; Biochemical Hallmark</h5>' +
              '<p>' + esc(spotter.micro) + '</p>' +
            '</div>' +
            '<div class="spotter-detail-item" style="grid-column: 1 / -1;">' +
              '<h5>' + icon("target") + ' Practical Exam Viva Distinction &amp; Nutritional Intervention</h5>' +
      ...
      '<h2 class="mt-10">Explore Animal Nutrition Domains</h2>' +
      '<p class="muted mt-1">Structured comprehensive curriculum following VCI MSVE 2016 guidelines.</p>' +
      '<div class="home-domains-grid">' +
        homeDomainCard("theory", "Theory Curriculum", "Four units · 68 topics", "Principles of nutrition, feed tech, ruminant feeding, and non-ruminant & poultry nutrition.", readPct, readCount + " / " + allTopics + " read", "#/theory", "ico--blue") +
        homeDomainCard("practical", "Practical Lab & Feed Tech", "Four units · 29 practical labs", "Feed microscopy, proximate analysis, silage making, feed formulation, and ration balancing.", null, "4 Practical Units", "#/practical", "ico--teal") +
        ...
        homeDomainCard("why", "WHY Mechanisms", totalWhy + " comparative explanations", "Comparative species digestion, rumen bioenergetics, and nutritional mechanisms.", null, totalWhy + " Mechanisms", "#/why", "ico--purple") +
        homeDomainCard("dashboard", "Clinical Dashboard", "Analytics & SRS pipeline", "Nutrition mastery gauge, 84-day heatmap, weak spots and Leitner memory queue.", Math.round(masteryXp / 10), masteryXp + " / 1000 XP", "#/dashboard", "ico--blue") +
      '</div>' +
      ...
      '<div class="home-exam-grid">' +
        homePaperCard("Paper I", "Principles, Feed Tech &amp; Ruminant-I", [1, 2], p1Read, p1Topics, p1Pct, "paper-1", "paper-badge--p1", "fill--blue") +
        homePaperCard("Paper II", "Ruminant-II &amp; Non-Ruminant Nutrition", [3, 4], p2Read, p2Topics, p2Pct, "paper-2", "paper-badge--p2", "fill--amber") +
        homePaperCard("Practical Exam", "Feed Analysis, Processing &amp; Rationing", [1, 2, 3, 4], pracRead, pracTopics, pracPct, "practical", "paper-badge--p2", "fill--teal") +
      '</div>' +
      ...
      '<div class="footer-credits-wrap">' +
        ...
        '<div class="footer-nav">' +
          '<div class="footer-nav__head">Browse Animal Nutrition</div>' +
          '<div class="footer-nav__links">' +
            '<a href="#/theory">Theory Units 1–4</a>' +
            '<a href="#/practical">Practical Units 1–4</a>' +
    ...
    view.innerHTML =
      '<div class="pagehead">' +
        ...
        '<p class="lede">' + (isTheory
          ? "The four theory units of the VCI Animal Nutrition syllabus (Units 1–4, Papers I & II)."
          : "The four practical units: feed microscopy, proximate analysis, conservation, and ration computation.") + '</p>' +
    ...
    if (hasContent(t.id)) {
      ...
      body =
        ...
        (c.img
          ...
          : '<div class="nutrition-image-placeholder"><div class="nutrition-placeholder-body">' +
              icon("search") +
              '<div class="nutrition-placeholder-title">High-Quality Animal Nutrition Visuals in Development</div>' +
              '<div class="nutrition-placeholder-sub">Carefully curated feed microscopy micrographs, forage diagrams, processing flowcharts, and metabolism pathways are in compilation.</div>' +
            '</div></div>') +
  ...
  /* The reading text of a lesson. Buttons, the toolbar, the note box and the
     "My highlights" list are not lesson text, so they are never searched or
     marked. Text already inside a highlight IS included, so the flattened
     string is the same before and after marking and occurrence numbers stay
     stable (a highlight inside a highlight simply nests). */
  var HL_SKIP = ".block--hl, .toolbar, .notebox, .pager, .hl-popup, button, textarea, input, select, script, style";
  ...
  // Whitespace in the saved text will not match the DOM exactly (line breaks,
  // paragraph joins), so any run of whitespace — or none, where a selection
  // crossed from one paragraph into the next — counts as a match.
  ...
  /* Which occurrence of `text` did the student actually select?
     Finds the selection's position in the lesson text and picks the
     match that starts nearest to it. */
  function selectionOccurrence(root, range, text) {
    if (!root || !range || !text) return 0;
    var re = hlRegex(text);
    if (!re) return 0;
    ...
    for (var i = 0; i < flat.nodes.length; i++) {
      var n = flat.nodes[i];
      if (n === range.startContainer) { pos = flat.bounds[i].start + range.startOffset; break; }
      // selection starts on an element boundary: first text node at/after it
      var cmp;
      try { cmp = range.comparePoint(n, 0); } catch (e) { cmp = -1; }
      if (cmp >= 0) { pos = flat.bounds[i].start; break; }
    }
    if (pos < 0) return 0;

    var best = 0, bestDist = Infinity;
    matches.forEach(function (mt, k) {
      var d = Math.abs(mt.index - pos);
      if (d < bestDist) { bestDist = d; best = k; }
    });
    return best;
  }

  /* Wrap occurrence number `occ` (falls back to the first if the lesson text
     changed and it no longer exists). Returns true if one was wrapped. */
  function wrapMatch(root, re, color, key, occ) {
    var flat = flattenText(root);
    var nodes = flat.nodes, bounds = flat.bounds;
    if (!nodes.length) return false;

    var matches = allMatches(flat.full, re);
    if (!matches.length) return false;
    var hit = matches[occ] || matches[0];
    var m = { index: hit.index, 0: flat.full.substr(hit.index, hit.len) };
    ...
    for (var k = to.n; k >= from.n; k--) {
      ...
      if (e <= s) continue;
      // gaps between paragraphs / list items are layout, not text to colour
      if (!/\S/.test(node.nodeValue.slice(s, e))) continue;
      ...
      mark.setAttribute("data-hl-occ", String(matches[occ] ? occ : 0));
  ...
  function highlightInElement(root, searchText, color, occ) {
    ...
    // Only the occurrence the student selected is marked — one saved
    // highlight shows as one passage, exactly where it was made.
    wrapMatch(root, re, color, needle, occ || 0);
  }
  ...
  function attachHighlightSelectionUI(panel, topicId) {
    ...
    popup.querySelectorAll(".hl-popup-btn").forEach(function (btn) {
      ...
      btn.addEventListener("click", function (e) {
        ...
        // re-colouring an existing highlight: drop the old mark first
        panel.querySelectorAll("mark.hl-inline").forEach(function (mk) {
          if (mk.getAttribute("data-hl-text") === text && mk.getAttribute("data-hl-occ") === String(occ)) {
  ...
  function wireUnhlButtons(topicId) {
    els("[data-unhl]").forEach(function (b) {
      b.onclick = function () {
        var o = parseInt(b.getAttribute("data-unhl-occ"), 10);
        store.removeHighlight(topicId, b.getAttribute("data-unhl"), isNaN(o) ? undefined : o);
        renderTopic();
      };
    });
  }
  ...
  function wireInlineMarks(topicId) {
    els(".hl-inline").forEach(function (m) {
      m.onclick = function (e) {
        ...
        var o = parseInt(m.getAttribute("data-hl-occ"), 10);
        store.removeHighlight(topicId, txt, isNaN(o) ? undefined : o);
  ...
  var onboardSlides = [
    {
      ...
      title: "Animal Nutrition Studio",
      body: "Built specifically for 2nd-year B.V.Sc &amp; A.H. students under VCI MSVE 2016. Covers all 4 VCI Theory Units, 4 Practical Units, bioenergetics, feed technology, ruminant and non-ruminant feeding, and ration balancing.",
      icon: "book"
    },
    {
      kicker: "DUAL STUDY DEPTHS",
      title: "Standard vs Deep View",
      body: "Every lesson features <b>Standard View</b> for high-yield exam revision and <b>Deep View</b> for comprehensive biochemical mechanisms, feed processing flowcharts, metabolic pathways, and ration computation steps. Switch anytime at the top of each lesson.",
      icon: "sparkle"
    },
    {
    ...
    },
    {
      ...
      body: "Install this app on your phone, tablet, or laptop. It works completely offline in nutrition labs, feed analytical facilities, livestock farms, classrooms, and hostels with zero internet required.",
      icon: "download"
    }
  ];
      ...
      els("[data-hl-pick]").forEach(function (btn) {
        btn.addEventListener("click", function (e) {
          ...
          if (sel) {
            ...
            store.addHighlight(t.id, sel, col, selectionOccurrence(lessonMain, savedRange, sel));
  ...
  function exportHighlights() {
    ...
    var lines = [
      "# Animal Nutrition Study Highlights",
  ...
  function exportNotes() {
    ...
    var lines = [
      "# Animal Nutrition Personal Notes",
      "ICAR-Indian Veterinary Research Institute · Izatnagar",
      "Exported on: " + new Date().toLocaleDateString() + "\n"
    ];
    keys.forEach(function (id) {
  ...
  function renderLibrary() {
    ...
    view.innerHTML =
      ...
      '</div>' +
      '<div class="tabs">' +
        [['bookmarks', 'Bookmarks', 'star'], ['notes', 'Notes', 'note'], ['highlights', 'Highlights', 'pen'], ['glossary', 'Glossary (430+)', 'book']].map(function (item) {
    ...
    if (tab === "bookmarks") {
      ...
      els("[data-unhl-lib]").forEach(function (b) {
        b.addEventListener("click", function () {
          ...
          var o = parseInt(b.getAttribute("data-unhl-occ"), 10);
          store.removeHighlight(id, txt, isNaN(o) ? undefined : o);
          renderLibrary();
        });
      });
    }
      ...
      var toolbarHtml =
        '<div class="lib-topbar">' +
          '<div class="hl-toolbar">' +
            '<div class="hl-search-wrap">' +
              icon("search", "hl-search-icon") +
              '<input type="search" class="hl-search-input" id="gloss-search" placeholder="Search ' + allTerms.length + ' animal nutrition definitions and terms…" value="' + esc(state._glossSearch || "") + '">' +
            '</div>' +
            '<div class="hl-filter-chips">' +
  ...
  function renderMe() {
    ...
    view.innerHTML =
      ...
      '<div class="card mb-4">' +
        ...
        '<p class="muted mt-2">Get an alert when flashcards and high-yield animal nutrition questions are due for active recall.</p>' +
  ...
  function _maybeShowSrsNotification() {
    ...
    var lastNotified = localStorage.getItem("vanut-notify-last");
    if (lastNotified === todayStr) return;

    var due = store.dueSrs().length;
    var msg = due > 0
      ? "You have " + due + " question" + (due === 1 ? "" : "s") + " due for review today in Spaced Repetition."
      : "Time for your daily Animal Nutrition recall review!";

    var opts = {
      body: msg,
      icon: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><rect width='32' height='32' rx='7' fill='%231565c0'/><text x='16' y='22' font-size='16' font-family='monospace' font-weight='bold' fill='white' text-anchor='middle'>AN</text></svg>",
      badge: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><rect width='32' height='32' rx='7' fill='%231565c0'/><text x='16' y='22' font-size='16' font-family='monospace' font-weight='bold' fill='white' text-anchor='middle'>AN</text></svg>",
      tag: "vanut-srs-daily",
      renotify: true
    };
    ...
    if (navigator.serviceWorker && navigator.serviceWorker.ready) {
      navigator.serviceWorker.ready.then(function (reg) {
        if (reg.showNotification) reg.showNotification("Animal Nutrition Studio", opts);
        else new Notification("Animal Nutrition Studio", opts);
      }).catch(function () {
        try { new Notification("Animal Nutrition Studio", opts); } catch (e) {}
      });
    } else {
      try { new Notification("Animal Nutrition Studio", opts); } catch (e) {}
    }
    localStorage.setItem("vanut-notify-last", todayStr);
  }
